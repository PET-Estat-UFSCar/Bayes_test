...
def update_formulas(n_clicks, verossimilhancas, a, b, c, d, m, x, x_bernoulli, n, conhecido):
    ...
    if n_clicks % 2 != 0:
        if verossimilhancas == "Bernoulli":
            return dcc.Markdown(r'''...''', mathjax=True) # Conteúdo da fórmula omitido para não exceder o limite
        # ... (todas as outras lógicas de fórmulas GERAIS permanecem aqui) ...
        else: # Normal-Gama
    ...
    # Cliques pares: mostram fórmulas APLICADAS
        ...
        if verossimilhancas == "Bernoulli":
            return dcc.Markdown(fr'''...''', mathjax=True) # Conteúdo da fórmula omitido para não exceder o limite
        # ... (todas as outras lógicas de fórmulas APLICADAS permanecem aqui) ...
        else: # Normal-Gama
            return dcc.Markdown(fr'''...''', mathjax=True)
    
# Nota: O conteúdo das strings de Markdown das fórmulas foi omitido aqui para manter a resposta focada na estrutura do código, 
# mas no arquivo final ele estaria completo, como no seu original.
