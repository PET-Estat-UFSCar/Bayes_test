...
def get_validation_states(a, b, c, d, x, m, n, conhecido, x_bernoulli, priori, verossimilhanca):
    ...
    if verossimilhanca == 'Bernoulli':
        if x_bernoulli is None: is_valid['geral'] = False
    elif verossimilhanca is not None:
        if x is None: is_valid['geral'] = False
        if verossimilhanca == "Binomial":
            if m is None: is_valid['geral'] = False
            elif m < 1: is_valid['m'] = False
...
def validate_inputs_and_set_styles(a, b, c, d, x, m, n, conhecido, x_bernoulli, priori, verossimilhanca):
    ...
    return [
        ...
        outputs['x'][0], outputs['x'][1],
        outputs['m'][0], outputs['m'][1],
        outputs['n'][0], outputs['n'][1],
        outputs['conhecido'][0], outputs['conhecido'][1]
    ]
